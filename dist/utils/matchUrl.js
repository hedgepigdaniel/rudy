...
exports.matchVal = exports.matchHash = exports.matchQuery = exports.default = void 0;
...
var _default = function _default(loc, matchers) {
...
var compilePath = function compilePath(pattern) {
  ...
  var keys = [];
  var re = (0, _pathToRegexp.default)(pattern, keys, {
    end: !partial,
    strict: strict
  });
  var compiledPattern = {
