...
export default (function (initialState, routes) {
  return function () {
...
export var createInitialState = function createInitialState(action) {
...
export var createPrev = function createPrev(location) {
  var n = location.n,
      i = location.index,
...
export var createPrevEmpty = function createPrevEmpty() {
  return {
    type: '',
    params: {},
    query: {},
