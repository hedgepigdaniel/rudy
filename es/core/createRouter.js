...
export default (function () {
  ...
  var location = options.location,
      ...
      scrollRestorerCreator = _options$restoreScrol === void 0 ? defaultCreateRestoreScroll() : _options$restoreScrol; // assign to options so middleware can override them in 1st pass if necessary
  ...
  var scrollRestorer = isServer() ? undefined : scrollRestorerCreator(api);
