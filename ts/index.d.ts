...
export declare class RestoreScroll<Action extends FluxStandardRoutingAction> {
    private options;
    private behavior;
    private lastRequest?;
    private api;
...
declare const _default: <Action extends FluxStandardRoutingAction>(options?: RestoreScrollOptions<Action> | undefined) => ScrollRestorerCreator<Action, RestoreScroll<Action>>;
