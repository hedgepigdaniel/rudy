...
var _scrollRestorer = _interopRequireDefault(require("@respond-framework/scroll-restorer"));
...
var _default = function _default() {
  ...
  var middlewares = arguments.length > 2 ? arguments[2] : undefined;
  var location = options.location,
      ...
      _options$createRestor = options.createRestoreScroll,
      createRestoreScroll = _options$createRestor === void 0 ? (0, _scrollRestorer.default)() : _options$createRestor; // assign to options so middleware can override them in 1st pass if necessary
  ...
  var scrollRestorer = (0, _utils.isServer)() ? undefined : createRestoreScroll(api);
  api.scrollRestorer = scrollRestorer;

  if (!middlewares) {
    middlewares = [_middleware.serverRedirect, // short-circuiting middleware
    ...
    (0, _middleware.call)('beforeLeave', {
      ...
      runOnServer: true
    }), _middleware.saveScroll, _middleware.enter, (0, _middleware.changePageTitle)({
      title: options.title
      ...
      cache: true,
      runOnServer: true
    }), _middleware.restoreScroll, (0, _middleware.call)('onComplete', {
      runOnServer: true
    })];
  }
