...
> = BaseShouldUpdateScroll<Request<Action, ScrollRestorer<Action>>, undefined>

export type RestoreScrollOptions<Action extends FluxStandardRoutingAction> = {
  shouldUpdateScroll?: ShouldUpdateScroll<Action>
}

export class ScrollRestorer<Action extends FluxStandardRoutingAction> {
  ...
  private api: Api<Action, ScrollRestorer<Action>>
  ...
  constructor(
    api: Api<Action, ScrollRestorer<Action>>,
...
export default <Action extends FluxStandardRoutingAction>(
  options?: RestoreScrollOptions<Action>,
): ScrollRestorerCreator<Action, ScrollRestorer<Action>> => (api) =>
  new ScrollRestorer(api, options)
