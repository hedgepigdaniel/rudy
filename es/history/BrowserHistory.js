...
import { addPopListener, removePopListener, isExtraneousPopEvent, restoreHistory, saveHistory, pushState, replaceState, go, getCurrentIndex } from './utils';
    ...
    value: function _setupPopHandling() {
      ...
      var handlePop = function handlePop() {
        ...
        if (!_this2.pendingPop) {
          n = getCurrentIndex() - _this2.index;
          _this2.pendingPop = n;
        ...
        _this2.currentPop = _this2.jump(n, false, n, true, revertPop); // `currentPop` used only by tests to await browser-initiated pops
      };
