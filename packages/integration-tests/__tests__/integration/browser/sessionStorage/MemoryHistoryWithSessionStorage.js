import { get } from '@respond-framework-test/rudy/src/history/utils/sessionStorage'
...
jest.mock('@respond-framework-test/rudy/src/history/utils/supports', () => ({
  ...require.requireActual(
    '@respond-framework-test/rudy/src/history/utils/supports',
  ),
