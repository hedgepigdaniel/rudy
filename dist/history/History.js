...
function () {
  function History(routes) {
    ...
    options.basenames = (options.basenames || []).map(function (bn) {
      return (0, _utils.cleanBasename)(bn);
    });
    var kind = 'load';
  ...
  _createClass(History, [{
    ...
    value: function push(path) {
      ...
      var action = (0, _utils.toAction)(this, path, state);
      var kind = 'push';
    ...
    value: function jump(delta) {
      ...
      var notify = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      var revertPop = arguments.length > 4 ? arguments[4] : undefined;
    ...
    value: function set(act, delta) {
      ...
      entries[i] = (0, _utils.toAction)(this, _objectSpread({}, entries[i], {}, {
      ...
      var entry = entries[i];
      var action = delta === 0 ? entry : (0, _utils.createActionRef)(this.location); // action dispatched must ALWAYS be current one, but insure it receives changes if delta === 0, not just entry in entries
    ...
    value: function reset(ents, i, n) {
      ...
      var _toEntries = (0, _utils.toEntries)(this, ents, i, n),
      ...
      var from = index === this.index && (0, _utils.createActionRef)(this.location); // if index stays the same, treat as "replace"
    ...
    value: function _createPrev(_ref, currentEntry) {
      ...
      if (!entry) return (0, _createReducer.createPrevEmpty)();
      ...
      return (0, _utils.createActionRef)(action); // build the action for that entry, and create what the resulting state shape would have looked like
    }
  }, {
    ...
    value: function _restore() {
      return (0, _utils.toEntries)(this); // by default creates action array for a single entry: ['/']
