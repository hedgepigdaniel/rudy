import createScene from '@respond-framework-test/rudy/src/createScene'
...
createTest(
  'createScene(routes, { scene, basename })',
  routes,
  {
    basenames: ['/base-name'],
  },
  [
    ...
    [
      'actions.second(partialAction)',
      actions.second({ params: { foo: 'bar' } }),
    ],
