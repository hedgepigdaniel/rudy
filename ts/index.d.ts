import { ScrollTarget } from 'scroll-behavior';
...
export declare type ShouldUpdateScroll<Action extends FluxStandardRoutingAction> = (request: Request<Action>) => ScrollTarget;
